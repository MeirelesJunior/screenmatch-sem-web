...
public interface SerieRepository extends JpaRepository<Serie, Long> {
   ...
   List<Serie> findByAtoresContainingAndAvaliacaoGreaterThanEqualIgnoreCase(String nomeAtor, double avaliacao);
  ...
  // List<Serie> findByTotalTemporadasLessThanEqualAndAvaliacaoGreaterThanEqual(int quantidadeTemporada, double avaliacao);
   ...
   List<Serie> seriesPorTemporadaEAvalicao(int quantidadeTemporada, double avaliacao);
